...
const Home = () => {
    ...
    useEffect(() => {
        if(selectedCategory) {
            ...
            setSelectedCategory(updateSelectedProducts);
        } else if(selectedCategory && keyword) {
            const updateSelectedProducts = products.filter((product) => product?.category === selectedCategory && product?.title?.toLowerCase().includes(keyword.toLowerCase()));
            setSelectedCategory(updateSelectedProducts);
        } else if(!selectedCategory && keyword) {
            const updateSelectedProducts = products.filter((product) => product?.title?.toLowerCase().includes(keyword.toLowerCase()));
            setSelectedCategory(updateSelectedProducts);
        } else if(!selectedCategory && !keyword) {
